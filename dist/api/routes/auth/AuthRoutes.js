...
var AuthRoutes = /** @class */ (function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.model.findOneBy({ email: email })];
                    case 1:
                        user = _c.sent();
                        req.session.userId = (_a = user) === null || _a === void 0 ? void 0 : _a.get('id');
                        return [2 /*return*/, res.send("You are logged in with id: " + ((_b = req.session) === null || _b === void 0 ? void 0 : _b.userId))];
                }
            });
        }); });
    };
    ...
    AuthRoutes.prototype.signupRoute = function () {
        ...
        this.router.post("/signup", [this.validator.requireEmail, this.validator.requirePassword], function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var errors, _a, email, password, encryptedPassword, user, response;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.validator.encryptPassword(password)];
                    case 1:
                        ...
                        return [4 /*yield*/, this.model.save(user)];
                    case 2:
                        response = _b.sent();
